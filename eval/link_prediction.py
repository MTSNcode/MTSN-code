...
def write_to_csv(test_results, output_name, model_name, dataset, time_steps,all_time, mod='val'):
    ...
    with open(output_name, 'a+') as f:
        for op in test_results:
            ...
            best_auc, best_f1, best_pr = test_results[op]
            f.write("{},{},{},{},{},{},{},{},{},{}\n".format(dataset, time_steps, model_name, op, mod, "AUC/f1/pr", best_auc, best_f1, best_pr, all_time))
...
def evaluate_classifier(train_pos, train_neg, val_pos, val_neg, test_pos, test_neg, source_embeds, target_embeds):
    ...
    test_results['SIGMOID'].extend([test_auc, test_f1, test_pr_auc])
    val_results['SIGMOID'].extend([val_auc, val_f1, val_pr_auc])
    ...
    # return test_auc, test_f1, test_pr_auc, val_auc, val_f1, val_pr_auc
