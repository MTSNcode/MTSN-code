...
flags.DEFINE_string('dataset', 'Enron_new', 'Dataset string.') # 'ml-10m_new' 'Enron_new'
flags.DEFINE_integer('time_steps', 9, '# time steps to train (+1)') # Predict at next time step.
...
# motif
flags.DEFINE_boolean('use_motifs', True, 'Use motif or not')
...
flags.DEFINE_integer('sgc_degree', 2, 'number of SGC layer')
flags.DEFINE_integer('TIME_degree', 4, 'number of TIME layer')
